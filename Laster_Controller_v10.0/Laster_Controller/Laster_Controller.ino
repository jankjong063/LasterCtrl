...
void checkForIdle() {
  if (millis() - lastActivityTime > 600000) {  // 10 minutes of inactivity
...
// Check inactivity and turn off the laser
...
void loop() {
  ...
  checkInactivity();
  checkForIdle();  // Check if we need to enter power-saving mode
