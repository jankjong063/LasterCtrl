...
set "SOURCE_PATH=C:\Users\88691\AppData\Local\Temp\arduino\sketches\6A4FB2DD2A0002F52E6A0DFCAB27FA49\Laster_Controller.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\Laster_Controller\Laster_Controller_v3.0"
