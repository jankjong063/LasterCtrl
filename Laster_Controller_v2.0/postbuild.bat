...
set "SOURCE_PATH=C:\Users\88691\AppData\\Local\Temp\arduino\sketches\99BE63FA9CA34AC22459500F29E0C852\Laster_Controller.ino.elf"

:: Set the destination folder (where the .ino file is located)
set "DEST_FOLDER=F:\PHD\Arduino_Projects\Laster_Controller\Laster_Controller_v2.0"
